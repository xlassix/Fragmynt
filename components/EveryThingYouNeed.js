          ...
          <div className={style.features}>
            <div className={style.first}>
              <div>
                <ScrollAnimation animateIn="fadeInUp">
                  ...
                  <p>
                    Join in with your own digital wallet or let Fragmynt handle
                    the hassle. Store your keys safely and trade without
                    hesitation.
                  </p>
                </ScrollAnimation>
              </div>
            ...
            <figure>
              <ScrollAnimation animateIn="fadeInUp">
                ...
                <p>
                  Jump in & out of markets with just a click of a button — no
                  prior trading experience required.
                </p>
              </ScrollAnimation>
            </figure>
            <figure>
              <ScrollAnimation animateIn="fadeInUp">
                ...
                <p>
                  Have some spare change lying around? Put it to work by
                  investing in your favourite TV show.
                </p>
              </ScrollAnimation>
            </figure>
            <figure>
              <ScrollAnimation animateIn="fadeInUp">
                ...
                <p>
                  Keep your transactions, data & assets secured by the
                  blockchain & complete encryption.
                </p>
              </ScrollAnimation>
            </figure>
            <figure>
              <ScrollAnimation animateIn="fadeInUp">
                ...
                <p>
                  Deposit & withdraw in your local currency without a worry.
                </p>
              </ScrollAnimation>
            </figure>
          </div>
